...
public final class AllTypes extends Message<AllTypes, AllTypes.Builder> {
  ...
  public boolean equals(Object other) {
    ...
    return unknownFields().equals(o.unknownFields())
        ...
        && Internal.equals(map_int32_int32, o.map_int32_int32)
        && Internal.equals(map_string_string, o.map_string_string)
        && Internal.equals(map_string_message, o.map_string_message)
        && Internal.equals(map_string_enum, o.map_string_enum)
        ...
        && Internal.equals(ext_map_int32_int32, o.ext_map_int32_int32)
        && Internal.equals(ext_map_string_string, o.ext_map_string_string)
        && Internal.equals(ext_map_string_message, o.ext_map_string_message)
        && Internal.equals(ext_map_string_enum, o.ext_map_string_enum);
  }
  ...
  public int hashCode() {
    ...
    if (result == 0) {
      ...
      result = result * 37 + (map_int32_int32 != null ? map_int32_int32.hashCode() : 0);
      result = result * 37 + (map_string_string != null ? map_string_string.hashCode() : 0);
      result = result * 37 + (map_string_message != null ? map_string_message.hashCode() : 0);
      result = result * 37 + (map_string_enum != null ? map_string_enum.hashCode() : 0);
      ...
      result = result * 37 + (ext_map_int32_int32 != null ? ext_map_int32_int32.hashCode() : 0);
      result = result * 37 + (ext_map_string_string != null ? ext_map_string_string.hashCode() : 0);
      result = result * 37 + (ext_map_string_message != null ? ext_map_string_message.hashCode() : 0);
      result = result * 37 + (ext_map_string_enum != null ? ext_map_string_enum.hashCode() : 0);
  ...
  public static final class NestedMessage extends Message<NestedMessage, NestedMessage.Builder> {
    ...
    public static final class Builder extends Message.Builder<NestedMessage, Builder> {
      ...
      public NestedMessage build() {
        return new NestedMessage(a, buildUnknownFields());
      }
    }
  ...
  private static final class ProtoAdapter_AllTypes extends ProtoAdapter<AllTypes> {
    private final ProtoAdapter<Map<Integer, Integer>> map_int32_int32 = ProtoAdapter.createMapAdapter(ProtoAdapter.INT32, ProtoAdapter.INT32);

    private final ProtoAdapter<Map<String, String>> map_string_string = ProtoAdapter.createMapAdapter(ProtoAdapter.STRING, ProtoAdapter.STRING);

    private final ProtoAdapter<Map<String, NestedMessage>> map_string_message = ProtoAdapter.createMapAdapter(ProtoAdapter.STRING, NestedMessage.ADAPTER);

    private final ProtoAdapter<Map<String, NestedEnum>> map_string_enum = ProtoAdapter.createMapAdapter(ProtoAdapter.STRING, NestedEnum.ADAPTER);

    private final ProtoAdapter<Map<Integer, Integer>> ext_map_int32_int32 = ProtoAdapter.createMapAdapter(ProtoAdapter.INT32, ProtoAdapter.INT32);

    private final ProtoAdapter<Map<String, String>> ext_map_string_string = ProtoAdapter.createMapAdapter(ProtoAdapter.STRING, ProtoAdapter.STRING);

    private final ProtoAdapter<Map<String, NestedMessage>> ext_map_string_message = ProtoAdapter.createMapAdapter(ProtoAdapter.STRING, NestedMessage.ADAPTER);

    private final ProtoAdapter<Map<String, NestedEnum>> ext_map_string_enum = ProtoAdapter.createMapAdapter(ProtoAdapter.STRING, NestedEnum.ADAPTER);
    ...
    public AllTypes redact(AllTypes value) {
      ...
      if (builder.map_int32_int32 != null) builder.map_int32_int32 = map_int32_int32.redact(builder.map_int32_int32);
      if (builder.map_string_string != null) builder.map_string_string = map_string_string.redact(builder.map_string_string);
      Internal.redactElements(builder.map_string_message, NestedMessage.ADAPTER);
      if (builder.map_string_enum != null) builder.map_string_enum = map_string_enum.redact(builder.map_string_enum);
      ...
      if (builder.ext_map_int32_int32 != null) builder.ext_map_int32_int32 = ext_map_int32_int32.redact(builder.ext_map_int32_int32);
      if (builder.ext_map_string_string != null) builder.ext_map_string_string = ext_map_string_string.redact(builder.ext_map_string_string);
      Internal.redactElements(builder.ext_map_string_message, NestedMessage.ADAPTER);
      if (builder.ext_map_string_enum != null) builder.ext_map_string_enum = ext_map_string_enum.redact(builder.ext_map_string_enum);
      builder.clearUnknownFields();
      return builder.build();
    }
  }
